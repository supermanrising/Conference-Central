...
class Speaker(ndb.Model):
    ...
    name                = ndb.StringProperty(required=True)
    speakingSessionKeys = ndb.StringProperty(repeated=True)
...
class Session(ndb.Model):
    """Session -- Session object with Conference as parent"""
    name            = ndb.StringProperty(required=True)
...
class SessionByDateForm(messages.Message):
    """SessionByDateForm - Session by date query inbound form message"""
    websafeConferenceKey    = messages.StringField(1)
